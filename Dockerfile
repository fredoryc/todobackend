...
RUN apk add --no-cache gcc python3-dev libffi-dev musl-dev linux-headers mariadb-dev util-linux py3-pip
...
RUN apk add --no-cache python3 mariadb-client bash py3-pip curl bats jq
